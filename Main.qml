...
MainView {
    ...
    applicationName: "circle-message.mivoligo"
    ...
    Metric {
        id: metrics
        name: "circleMessages" // Change it for your project
        format: momentMessage
        emptyFormat: daysMessage
        domain: "com.ubuntu.developer.circle-message.mivoligo" // Change it for your project
    }
